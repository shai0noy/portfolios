    ...
    <Dialog open={true} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box>
            <Typography variant="h4" component="div" fontWeight="bold">{data.name || data.ticker}</Typography>
            <Typography variant="subtitle1" color="text.secondary" component="span" sx={{ ml: 0 }}>{data.ticker} ({data.exchange})</Typography>
          </Box>
