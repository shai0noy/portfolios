...
(0, vitest_1.describe)('calculatePortfolioPerformance - Edge Cases', () => {
    const mkFetch = (historyMap) => {
        return async (t, e) => {
            const key = `${e}:${t}`;
    ...
    const mockRates = { current: { USD: 1, EUR: 0.9 }, ago1m: { USD: 1, EUR: 0.9 } };
    (0, vitest_1.it)('should correctly handle Dividends in Total Gain', async () => {
        const holdings = [{
                portfolioId: 'p1', ticker: 'DIVSTART', exchange: types_1.Exchange.NASDAQ,
                stockCurrency: types_1.Currency.USD, portfolioCurrency: types_1.Currency.USD,
                qtyVested: 10, totalQty: 10
            }];
        const txns = [
            { date: '2024-01-01T00:00:00.000Z', portfolioId: 'p1', ticker: 'DIVSTART', exchange: types_1.Exchange.NASDAQ, type: 'BUY', qty: 10, price: 100 },
            { date: '2024-01-02T00:00:00.000Z', portfolioId: 'p1', ticker: 'DIVSTART', exchange: types_1.Exchange.NASDAQ, type: 'DIVIDEND', qty: 0, price: 50 } // $50 Dividend
        ];
        const history = {
            'NASDAQ:DIVSTART': [
        ...
        const points = await (0, performance_1.calculatePortfolioPerformance)(holdings, txns, 'USD', mockRates, undefined, undefined, mkFetch(history));
        // Day 2:
        // Value: 10 * 100 = 1000.
        // Cost: 1000.
        // Unrealized: 0.
        ...
        (0, vitest_1.expect)(p2?.gainsValue).toBeCloseTo(50, 0.01);
        (0, vitest_1.expect)(p2?.holdingsValue).toBeCloseTo(1000, 0.01);
    });
    (0, vitest_1.it)('should correctly handle Fees in Total Gain', async () => {
        const holdings = [{
                portfolioId: 'p1', ticker: 'FEESTART', exchange: types_1.Exchange.NASDAQ,
                stockCurrency: types_1.Currency.USD, portfolioCurrency: types_1.Currency.USD,
                qtyVested: 10, totalQty: 10
            }];
        const txns = [
            { date: '2024-01-01T00:00:00.000Z', portfolioId: 'p1', ticker: 'FEESTART', exchange: types_1.Exchange.NASDAQ, type: 'BUY', qty: 10, price: 100 },
            { date: '2024-01-02T00:00:00.000Z', portfolioId: 'p1', ticker: 'FEESTART', exchange: types_1.Exchange.NASDAQ, type: 'FEE', qty: 0, price: 5 } // $5 Fee
        ];
        const history = {
            'NASDAQ:FEESTART': [
                { date: new Date('2024-01-01T00:00:00.000Z'), price: 100 },
        ...
        const p2 = points.find(p => p.date.getUTCDate() === 2);
        (0, vitest_1.expect)(p2).toBeDefined();
        (0, vitest_1.expect)(p2?.gainsValue).toBeCloseTo(-5, 0.01);
    });
    (0, vitest_1.it)('should handle Intraday Buy and Sell (Day Trading)', async () => {
        ...
        const holdings = []; // Empty at end
        const txns = [
            { date: '2024-01-01T10:00:00', portfolioId: 'p1', ticker: 'DAYTRADE', exchange: types_1.Exchange.NASDAQ, type: 'BUY', qty: 10, price: 100 },
            { date: '2024-01-01T14:00:00', portfolioId: 'p1', ticker: 'DAYTRADE', exchange: types_1.Exchange.NASDAQ, type: 'SELL', qty: 10, price: 110 }
        ];
        const history = {
            'NASDAQ:DAYTRADE': [
        ...
        if (p1) {
            (0, vitest_1.expect)(p1.gainsValue).toBeCloseTo(100, 0.01);
        }
    });
    (0, vitest_1.it)('should handle Currency Fluctuation (Stock Flat, Currency Moves)', async () => {
        ...
        const holdings = [{
                portfolioId: 'p1', ticker: 'EURSTOCK', exchange: types_1.Exchange.LSE, // Mock LSE as EUR source
                stockCurrency: types_1.Currency.EUR, portfolioCurrency: types_1.Currency.USD,
                qtyVested: 1, totalQty: 1
            }];
        const txns = [
            { date: '2024-01-01T00:00:00.000Z', portfolioId: 'p1', ticker: 'EURSTOCK', exchange: types_1.Exchange.LSE, type: 'BUY', qty: 1, price: 100, currency: types_1.Currency.EUR }
        ];
        const history = {
            'LSE:EURSTOCK': [
                { date: new Date('2024-01-01T00:00:00.000Z'), price: 100 },
        ...
        const points = await (0, performance_1.calculatePortfolioPerformance)(holdings, txns, 'USD', rates, undefined, undefined, mkFetch(history));
        const p2 = points.find(p => p.date.getUTCDate() === 2);
        // If constant rates used:
        // Cost: 100 EUR * 1.1 = 110 USD.
        // Value: 100 EUR * 1.1 = 110 USD.
        // Gain: 0.
        (0, vitest_1.expect)(p2?.gainsValue).toBeCloseTo(0, 0.01);
    });
});
